...
MACRO(subdirlist result curdir)
  ...
  SET(${result} ${dirlist})
ENDMACRO()
## adds source files to list given a base name
macro(add_files name list)
	set (extensions ".h" ".cpp" ".implementation.template.h" ".implementation.inline.h")
	foreach(extension ${extensions})
  		set(filename "${name}${extension}")
  		set(fullFile "${CMAKE_CURRENT_SOURCE_DIR}/${filename}")
  		if(EXISTS ${fullFile}) 
			set(${list} ${${list}} ${filename})			
		endif(EXISTS ${fullFile})
	endforeach(extension)
endmacro(add_files name list)
