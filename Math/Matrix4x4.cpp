...
/** Negation: -m\n
  ...
  */
Matrix4x4 IBDS::operator - (const Matrix4x4& a)
{ 
	Matrix4x4 m;
	for (int i=0; i < 4; i++)
		for (int j=0; j < 4; j++)
...
/** Addition: m1 + m2\n
  ...
  */
Matrix4x4 IBDS::operator + (const Matrix4x4& a, const Matrix4x4& b)
{ 
	Matrix4x4 m;
	for (int i=0; i < 4; i++)
		for (int j=0; j < 4; j++)
...
/** Multiplikation: m * v\n
  ...
  */
Vector3D IBDS::operator * (const Matrix4x4& m, const Vector3D& v) 
{
...
/** Multiplikation: m ^ p\n
  ...
  */
Vector3D IBDS::operator ^ (const Matrix4x4& m, const Vector3D& p) 
{
...
/** Multiplikation: d*a\n
  ...
  */
Matrix4x4 IBDS::operator * (const Real d, const Matrix4x4& a)
{
	Matrix4x4 m;
	for (int i=0; i < 4; i++)
		for (int j=0; j < 4; j++)
...
/** Stream-Ausgabe der Matrix
  */
std::ostream& IBDS::operator << (std::ostream& s, const Matrix4x4& m)
{ 
