...
*/
Matrix2x2 IBDS::operator - (const Matrix2x2& a)
{ 
...
*/
Matrix2x2 IBDS::operator + (const Matrix2x2& a, const Matrix2x2& b)
{ 
...
* Matrixmultiplikation von m1 mit m2
*/
Matrix2x2 IBDS::operator * (const Matrix2x3& a, const Matrix3x2& b) 
{
	Matrix2x2 c;
	for (int i=0; i < 2; i++)
	{
...
*/
Matrix2x2 IBDS::operator * (const Real d, const Matrix2x2& a)
{
...
/** Stream-Ausgabe der Matrix
  */
std::ostream& IBDS::operator << (std::ostream& s, const Matrix2x2& m)
{ 
	return s << m.v[0] << '\n' << m.v[1];
}
