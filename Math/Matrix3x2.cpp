...
/** Negation: -m\n
  ...
  */
Matrix3x2 IBDS::operator - (const Matrix3x2& a)
{ 
...
/** Addition: m1 + m2\n
  ...
  */
Matrix3x2 IBDS::operator + (const Matrix3x2& a, const Matrix3x2& b)
{ 
...
/** Multiplikation: m1 * m2\n
  ...
  */
Matrix3x2 IBDS::operator * (const Matrix3x2& a, const Matrix2x2& b) 
{
	Matrix3x2 c;
	for (int i=0; i < 3; i++)
	{
...
* Matrixmultiplikation von m1 mit m2
*/
Matrix3x2 IBDS::operator * (const Matrix3x3& a, const Matrix3x2& b) 
{
	Matrix3x2 c;
	for (int i=0; i < 3; i++)
	{
...
/** Multiplikation: d*a\n
  ...
  */
Matrix3x2 IBDS::operator * (const Real d, const Matrix3x2& a)
{
...
/** Stream-Ausgabe der Matrix
  */
std::ostream& IBDS::operator << (std::ostream& s, const Matrix3x2& m)
{ 
	return s << m.v[0] << '\n' << m.v[1] << '\n' << m.v[2];
}
