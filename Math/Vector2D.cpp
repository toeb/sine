...
/** Gleichheit: v1 == v2 \n
  ...
  */
bool IBDS::operator == (const Vector2D &a, const Vector2D &b)
{
...
/** Negation: -v1 \n
  ...
  */
Vector2D IBDS::operator - (const Vector2D& a)
{  
...
/** Addition: v1 + v2\n
  ...
  */
Vector2D IBDS::operator + (const Vector2D& a, const Vector2D& b)
{ 
...
/** Multiplikation mit Konstanter: v1*d\n
  ...
  */
Vector2D IBDS::operator * (const Vector2D& a, const Real d)
{ 
...
/** Multiplikation mit Konstanter: d*v1\n
  * Multipliziert alle Komponenten von v1 mit d
  */
Vector2D IBDS::operator * (const Real d, const Vector2D& a)
{ 
	return a*d; 
}
...
/** Skalarprodukt: v1 * v2\n
  * x1*x2 + y1*y2 + z1*z2
  */
Real IBDS::operator * (const Vector2D& a, const Vector2D& b)
{ 
	return (a.v[0]*b.v[0] + a.v[1]*b.v[1]); 
}
...
/** Multiplikation von Zeilenvektor v mit 2x2 Matrix m\n
  ...
  */
Vector2D IBDS::operator * (const Vector2D& v, const Matrix2x2& m) 
{
...
/** Multiplikation von Spaltenvektor v mit 2x2 Matrix m\n
  ...
  */
Vector2D IBDS::operator * (const Matrix2x2& m, const Vector2D& v) 
{
...
* Rechtsseitige Matrixmultiplikation
*/
Vector2D IBDS::operator * (const Vector3D& v, const Matrix3x2& m) 
{
...
* Linksseitige Matrixmultiplikation
*/
Vector2D IBDS::operator * (const Matrix2x3& m, const Vector3D& v) 
{
...
/** Stream-Ausgabe des Vektors 
  */
std::ostream& IBDS::operator << (std::ostream& s, const Vector2D& v)
{ 
