...
Vector3D _e2(0,1,0);
Vector3D _e3(0,0,1);
Vector3D _ones(1,1,1);
const Vector3D& Vector3D::Ones(){
  return _ones;
}
...
/** Gleichheit: v1 == v2 \n
  ...
  */
bool nspace::operator == (const Vector3D &a, const Vector3D &b)
{
...
/** Negation: -v1 \n
  ...
  */
Vector3D nspace::operator - (const Vector3D& a)
{  
...
/** Multiplikation mit Konstanter: v1*d\n
  ...
  */
Vector3D nspace::operator * (const Vector3D& a, const Real d)
{ 
...
/** Multiplikation mit Konstanter: d*v1\n
  * Multipliziert alle Komponenten von v1 mit d
  */
Vector3D nspace::operator * (const Real d, const Vector3D& a)
{ 
	return a*d; 
}
...
/** Skalarprodukt: v1 * v2\n
  * x1*x2 + y1*y2 + z1*z2
  */
Real nspace::operator * (const Vector3D& a, const Vector3D& b)
{ 
	return (a.v[0]*b.v[0] + a.v[1]*b.v[1] + a.v[2]*b.v[2]); 
}
...
/** Multiplikation von Zeilenvektor v mit 3x3 Matrix m\n
  ...
  */
Vector3D nspace::operator * (const Vector3D& v, const Matrix3x3& m) 
{
...
/** Multiplikation von Spaltenvektor v mit 3x3 Matrix m\n
  ...
  */
Vector3D nspace::operator * (const Matrix3x3& m, const Vector3D& v) 
{
...
* Rechtsseitige Matrixmultiplikation
*/
Vector3D nspace::operator * (const Vector3D& v, const Vector1D& m) 
{
...
* Linksseitige Matrixmultiplikation
*/
Vector3D nspace::operator * (const Vector1D& m, const Vector3D& v) 
{
	return Vector3D (v.v[0]*m.v, v.v[1]*m.v, v.v[2]*m.v);
}
...
* Linksseitige Matrixmultiplikation
*/
Vector3D nspace::operator * (const Matrix3x2& m, const Vector2D& v) 
{
...
* Rechtsseitige Matrixmultiplikation
*/
Vector3D nspace::operator * (const Vector2D& v, const Matrix2x3& m) 
{
...
/** Multiplikation der Kreuproduktmatrix von v mit der 3x3 Matrix m.
  */
Matrix3x3 nspace::operator , (const Matrix3x3& m, const Vector3D& v) 
{
...
/** Multiplikation der 3x3 Matrix m mit der Kreuproduktmatrix von v.
  */
Matrix3x3 nspace::operator , (const Vector3D& v, const Matrix3x3& m) 
{
	Matrix3x3 V = Matrix3x3 (Vector3D (0, -v.v[2], v.v[1]), 
							Vector3D (v.v[2], 0, -v.v[0]), 
							Vector3D (-v.v[1], v.v[0], 0));
...
/** Stream-Ausgabe des Vektors 
  */
std::ostream& nspace::operator << (std::ostream& s, const Vector3D& v)
{ 
