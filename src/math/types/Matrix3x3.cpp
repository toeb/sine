...
bool nspace::operator== (const Matrix3x3& a,const Matrix3x3& b){
...
/** Negation: -m\n
  ...
  */
Matrix3x3 nspace::operator - (const Matrix3x3& a)
{ 
...
/** Addition: m1 + m2\n
  ...
  */
Matrix3x3 nspace::operator + (const Matrix3x3& a, const Matrix3x3& b)
{ 
...
/** Multiplikation: d*a\n
  ...
  */
Matrix3x3 nspace::operator * (const Real d, const Matrix3x3& a)
{
