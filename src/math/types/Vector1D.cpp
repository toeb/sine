...
/** Gleichheit: v1 == v2 \n
  ...
  */
bool nspace::operator == (const Vector1D &a, const Vector1D &b)
{
	return (a.v == b.v);
...
/** Negation: -v1 \n
  ...
  */
Vector1D nspace::operator - (const Vector1D& a)
{  
	return Vector1D(-a.v); 
}
...
/** Addition: v1 + v2\n
  ...
  */
Vector1D nspace::operator + (const Vector1D& a, const Vector1D& b)
{ 
...
/** Multiplikation mit Konstanter: v1*d\n
  ...
  */
Vector1D nspace::operator * (const Vector1D& a, const Real d)
{ 
...
/** Multiplikation mit Konstanter: d*v1\n
  * Multipliziert alle Komponenten von v1 mit d
  */
Vector1D nspace::operator * (const Real d, const Vector1D& a)
{ 
	return a*d; 
}
...
/** Skalarprodukt: v1 * v2\n
  * x1*x2 + y1*y2 + z1*z2
  */
Real nspace::operator * (const Vector1D& a, const Vector1D& b)
{ 
	return (a.v*b.v); 
}
...
/** Stream-Ausgabe des Vektors 
  */
std::ostream& nspace::operator << (std::ostream& s, const Vector1D& v)
{ 
	return s << "( " << v.v << " )"; 
}
