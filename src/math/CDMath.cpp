...
//   */
// bool CDMath::distancePointEdge (const Vector3D &p, const Vector3D &e1, const Vector3D &e2, Real & dist, Vector3D &l)
// {
...
//   \param l Rückgabe des Lotpunktes
//   */
// bool CDMath::distancePointEdge2 (const Vector3D &p, const Vector3D &e1, const Vector3D &e2, Real & dist, Vector3D &l)
// {
// 	// Richtungsvektor der Kante
// 	Vector3D v = e2 - e1;
// 	
