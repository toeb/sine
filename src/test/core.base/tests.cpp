...
private:                                                                                                          \
  class PROPERTYCLASS(NAME) : public virtual nspace::TypedProperty<CurrentClassType,DS_PROPERTY_TYPE_NAME(NAME)>{ \
public:                                                                                                           \
    ...
    void setTypedValue(CurrentClassType *  object, DS_PROPERTY_TYPE_NAME(NAME) value) const {                     \
      object->DS_PROPERTY_SETTER_NAME(NAME) (value);                                                               \
    }                                                                                                             \
    DS_PROPERTY_TYPE_NAME(NAME) getTypedValue(const CurrentClassType *  object) const {                           \
...
private:                                                                                                          \
  ...
  {                                                                                                               \
    auto type = const_cast<nspace::Type*>(static_cast<ConstTypePtr>(typeof(CurrentClassType)));                                              \
