...
void RungeKuttaFehlberg45::calculateRungeKutta45(Real t_i, const StateMatrix & x_i, Real h, StateMatrix & rk4, StateMatrix & rk5){
  // calculate k values
  k1 = h * f(t_i    ,x_i,h);
  k2 = h * f(c20*t_i,x_i+c21*k1 ,h);
  k3 = h * f(c30*t_i,x_i+c31*k1 + c32 * k2,h);
  k4 = h * f(c40*t_i,x_i+c41*k1 + c42 * k2+c43 * k3,h);
  k5 = h * f(c50*t_i,x_i+c51*k1 + c52 * k2+c53 * k3 + c54 * k4,h);
  k6 = h * f(c60*t_i,x_i+c61*k1 + c62 * k2+c63 * k3 + c64 * k4 + c65 * k5,h);
...
/**
  ...
  */
void RungeKuttaFehlberg45::doStep(Real t_i, Real h_i){
