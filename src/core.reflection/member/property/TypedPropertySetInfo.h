...
namespace nspace{
  ...
  template<typename OwningClass, typename ValueType>
  uint  TypedPropertySetInfo<OwningClass,ValueType>::getElementCount(void  * ptr)const{
  ...
  template<typename OwningClass, typename ValueType>
  // sets the value of the property set at i
  bool  TypedPropertySetInfo<OwningClass,ValueType>::setElement(void  * object, uint i, const void * value)const{
    auto typedObject = static_cast<OwningClass*>(object);
    auto typedValue = reinterpret_cast<const ValueType*>(value);
    if(!typedObject)return false;
  ...
  // gets the value of the property set at i
  template<typename OwningClass, typename ValueType>
  bool  TypedPropertySetInfo<OwningClass,ValueType>::getElement(const void * object, uint i, void * value)const{
  ...
  template<typename OwningClass, typename ValueType>
  bool  TypedPropertySetInfo<OwningClass,ValueType>::deserializeElement(void  * object, uint i, std::istream & in)const{
  ...
  template<typename OwningClass, typename ValueType>
  bool  TypedPropertySetInfo<OwningClass,ValueType>::serializeElement(void * object,uint i,  std::ostream & out)const{
    OwningClass * owningClass = static_cast<OwningClass*>(object);
    if(!owningClass)return false;
    ValueType value;
